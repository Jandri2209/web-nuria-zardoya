...
// VERSIÓN CORREGIDA CON NONCE PARA CSP
  ...
  if (event.path.endsWith("/callback")) {
                    ...
                    (function(){
                      ...
                      try {
                        if (window.opener && t) {
                          ...
                          // Mantenemos el tiempo de espera aumentado que probamos antes
                          setTimeout(function(){ window.close(); }, 500);
                        } else {
                          document.body.textContent = 'Autorización completada. Puedes cerrar esta ventana.';
                        }
                      } catch(e){
                        document.body.textContent = 'Error al comunicar. Cierra esta ventana.';
                      }
                    })();
                    </script></body></html>`;
    ...
    return {
      ...
      headers: {
        ...
        "Content-Security-Policy": csp // **<-- AÑADIDO**
      },
      body: html
    };
  }
