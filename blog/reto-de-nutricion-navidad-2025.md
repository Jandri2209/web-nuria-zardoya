...
1. **Te apuntas al reto** rellenando un formulario de contacto.
2. **Realizas el pago** del pack a través de una pasarela segura (PayPal).
3. Una vez confirmado el pago, **recibirás un correo** con el acceso a la carpeta privada donde estará todo el material del reto.
